...
public class JobAdvertManager implements JobAdvertService{
	...
	public Result delete(int advertId) {
		this.jobAdvertDao.delete(this.jobAdvertDao.findById(advertId));
		return new SuccessResult("Success: Job advertisement deleted");
	}
	...
	public DataResult<List<JobAdvertWithDetailsDto>> getJobAdvertWithDetailsOnlyUnverifieds() {
		return new SuccessDataResult<List<JobAdvertWithDetailsDto>>(this.jobAdvertDao.getJobAdvertWithDetailsOnlyUnverifieds(),"Data listed");
	}
