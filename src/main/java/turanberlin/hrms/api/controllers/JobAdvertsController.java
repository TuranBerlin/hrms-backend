...
public class JobAdvertsController {
	...
	@GetMapping("/get/jobAdvertWithDetails/onlyUnverifieds")
	public DataResult<List<JobAdvertWithDetailsDto>> getJobAdvertWithDetailsOnlyUnverifieds() {
		return this.jobAdvertService.getJobAdvertWithDetailsOnlyUnverifieds();
	}
	...
	@PostMapping("/delete/jobAdvert")
	public Result delete(int advertId) {
		return this.jobAdvertService.delete(advertId);
	}

	@PostMapping("/changeStatus/jobAdvert")
	public Result setAdvertStatus( Boolean status, @RequestParam int advertId) {
